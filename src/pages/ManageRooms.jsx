...
function ManageRooms() {
  ...
  const fetchFloors = async () => {
    try {
      const response = await axios.get("https://room-booking-backend-production-7a12.up.railway.app/floors");
  ...
  const fetchRooms = async () => {
    try {
      const response = await axios.get("https://room-booking-backend-production-7a12.up.railway.app/rooms");
  ...
  const handleAddFloor = async () => {
    try {
      const response = await axios.post("https://room-booking-backend-production-7a12.up.railway.app/floors", {});
  ...
  const handleAddRoom = async (e) => {
    ...
    try {
      const response = await axios.post("https://room-booking-backend-production-7a12.up.railway.app/rooms", {
  ...
  const handleUpdateRoom = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://room-booking-backend-production-7a12.up.railway.app/rooms/${editingRoomId}`,
        {
